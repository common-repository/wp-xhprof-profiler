<?php
/*
Plugin Name: WP XHProf Profiler
Plugin URI: http://www.berriart.com/en/wp-xhprof-profiler/
Description: Adds PHP profiling support to your Wordpress using Facebook's XHProf Profiler.
Version: 0.9
...
function berriart_xhprof_profiler_xhprof_and_debug_is_enabled() {
    $enabled = false;
    if(defined('WP_DEBUG') && WP_DEBUG == true && berriart_xhprof_profiler_xhprof_is_enabled()) {
        $enabled = true;
    }
